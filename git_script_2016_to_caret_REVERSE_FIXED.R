...
# # #
exp_tsss<-nchar(e.coli_U00096.2)-exp_tsss
...
gentsss<-nchar(e.coli_U00096.2)-gentsss
...
isltsss<-nchar(e.coli_U00096.2)-isltsss
...
lowscoretsss<-nchar(e.coli_U00096.2)-lowscoretsss
...
###check up - finding promoters from different strands that is closely located
#tssdists<-c()
#for (i in exp_tsss[which(exp_strands=='forward')]){
 #tssdists<-rbind(tssdists, min(i-sort(exp_tsss[which(exp_strands=='forward')])))
#}

#sort(tssdists)
#exp_tsss[which(tssdists==-15426)]
# 4358129
#exp_strands[which(exp_tsss==4358129)]
#exp_strands[which(exp_tsss==4339910)]

#min(abs(exp_tsss[which(exp_strands=='forward')]-4358129)) #174
#exp_tsss==
