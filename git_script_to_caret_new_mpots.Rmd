...
for (i in 1:length(exp_tsss)) {
  if (exp_strands[i]=='forward') {
    ...
    p<-lseqspline1D(substr(e.coli_U00096.2, exp_tsss[i]-250, exp_tsss[i]+150), bound=c(100, 300), ref=251 )
    ...
    p<-lseqspline1D(substr(reverseComplement_e.coli_U00096.2, exp_tsss[i]-250, exp_tsss[i]+150), bound=c(100, 300), ref=251 )
...
for (i in 1:length(nottsss)) {
  if (notstrands[i]=='forward') {
    ...
    p<-lseqspline1D(substr(e.coli_U00096.2, nottsss[i]-250, nottsss[i]+150), bound=c(100, 300), ref=251 )
    ...
    p<-lseqspline1D(substr(reverseComplement_e.coli_U00096.2, nottsss[i]-250, nottsss[i]+150), bound=c(100, 300), ref=251 )
...
notmpots<-rbind(notmpotsforward, notmpotsreverse)
```
...
for (i in 1:length(dataset_gen)) {
  if (genstrands[i]=='forward') {
   ...
   p<-lseqspline1D(substr(e.coli_U00096.2, gentsss[i]-250, gentsss[i]+150), bound=c(100, 300), ref=251 )
    ...
    p<-lseqspline1D(substr(reverseComplement_e.coli_U00096.2, gentsss[i]-250, gentsss[i]+150), bound=c(100, 300), ref=251 )
...
for (i in 1:length(dataset_isl)) {
  if (islstrands[i]=='forward') {
    ...
    p<-lseqspline1D(substr(e.coli_U00096.2, isltsss[i]-250, isltsss[i]+150), bound=c(100, 300), ref=251 )
    ...
    p<-lseqspline1D(substr(reverseComplement_e.coli_U00096.2, isltsss[i]-250, isltsss[i]+150), bound=c(100, 300), ref=251 )
...
for (i in 1:2000) {
  if (lowscorestrands[i]=='forward') {
    ...
    lowscoregc200forward<-rbind(lowscoregc200forward, gc200matlab1[(as.numeric(lowscoretsss[i])-150):(as.numeric(lowscoretsss[i])+50)])
      ...
      p<-lseqspline1D(substr(e.coli_U00096.2, lowscoretsss[i]-250, lowscoretsss[i]+150), bound=c(100, 300), ref=251 )
    ...
    lowscoregc200reverse<-rbind(lowscoregc200reverse, (gc200matlab2[(as.numeric(lowscoretsss[i])-50):(as.numeric(lowscoretsss[i])+150)]))
         ...
         p<-lseqspline1D(substr(reverseComplement_e.coli_U00096.2, lowscoretsss[i]-250, lowscoretsss[i]+150), bound=c(100, 300), ref=251 )
